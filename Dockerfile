...
RUN sudo chown hduser:hduser $HADOOP_HOME/etc/hadoop/docker-entrypoint.sh && \
    sudo chmod +x $HADOOP_HOME/etc/hadoop/docker-entrypoint.sh

ENV PATH $PATH:$HADOOP_HOME/bin:$HADOOP_HOME/sbin

ADD mapreduce/ examples/ 
